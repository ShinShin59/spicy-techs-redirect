...
/** Order: top-left, top-right, bottom-right, bottom-left (clockwise) → grid rows: [economic, military], [statecraft, expansion] */
...
const Developments = () => {
  ...
  return (
    <div className={`flex ${isLandscape ? "flex-row items-start gap-4 ml-36" : "flex-col"}`}>
      <div className="flex flex-col">
        ...
        {!isLandscape && (
          <div id="developments-info" className="flex flex-col items-center pt-2 gap-1">
      ...
      {isLandscape && (
        <div id="developments-info" className="flex flex-col items-start pt-9 gap-1 shrink-0">
          <div className="flex items-center gap-2">
            <span
              className="tabular-nums text-[0.75rem]"
              style={{ color: "#D57E3B" }}
